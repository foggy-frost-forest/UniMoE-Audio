...
| This is a four on the floor style of production. The song is a drum and bass type of song with a bright and fuzzy synth to add a melodic element. The first part of the song feels suspenseful. | <audio controls width="400" height="50"> <source src="https://github.com/user-attachments/assets/08a9ee44-f62b-465f-9793-7e2a45573d29" type="audio/mpeg"> demo 3</audio>|
